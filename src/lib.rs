...
/// An error that can be used when matching on an enum and finding no known variant.
///
/// Generated by [`TryFromKnownRepr`] derive macro, but can also be used elsewhere to unify
/// some error handling converns.
